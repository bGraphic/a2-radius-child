<?php
/*
Plugin Name: A2 Array Toolkit
Description: A translatable version of  array toolkit
Version: 1.0.2
Author: Array
*/
...
class Array_Toolkit {
	...
	public function __construct() {
		...
		// Define textdomain
		load_plugin_textdomain( 'array-toolkit', false, dirname( plugin_basename( __FILE__ ) ) . '/includes/languages/');
